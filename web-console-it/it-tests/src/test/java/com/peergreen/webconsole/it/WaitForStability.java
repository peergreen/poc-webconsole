...
public class WaitForStability {
    ...
    public Option[] config() throws URISyntaxException {
        ...
        return options(systemProperty("admin.console.test.configuration").value(file.toString()),
                ...
                mavenBundle("com.peergreen.webconsole", "vaadin-all").version("0.0.1-SNAPSHOT"),
                mavenBundle("com.peergreen.webconsole", "htmlunit-all").version("0.0.1-SNAPSHOT"),
                mavenBundle("com.peergreen.webconsole", "web-console-api").version("0.0.1-SNAPSHOT"),
                mavenBundle("com.peergreen.webconsole", "web-console-core").version("0.0.1-SNAPSHOT"),
                junitBundles()
        );
    }
